...
#
# NOTE ALSO: It is sufficient to mark the numbers starting from curr_prime ** 2, as all the smaller multiples will have already been marked at that point. 
# 2 start at 4
# 3 start at 9
# 5 start at 25
# This also means that the algorithm is allowed to terminate at sqrt of num
...
def summation_of_primes(num)
	...
	while curr_prime <= Math.sqrt(num) + 1
...
# NOTE: I didn't use the ability to start marking the numbers starting from curr_prime ** 2 in the above code, so more room for improvement
